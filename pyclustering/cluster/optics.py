...
class optics_descriptor:
    ...
    def __cmp__(self, other):
        return cmp(self.reachability_distance, other.reachability_distance)
...
class optics:
    ...
    def reset_flags(self):
        for obj in self.__optics_objects:
            obj.processed = False
            obj.affected = False

    def get_optics_objects(self):
        for i in range(len(self.__sample_pointer)):
            index = self.__optics_objects[i].index_object
            self.__optics_objects[i].point = self.__sample_pointer[index]
